...
public class TapePipeline {
	...
	public void process(Mat source0) {
		...
		double blurRadius = 1.830131132627413;
		blur(blurInput, blurType, blurRadius, blurOutput);

		// Step RGB_Threshold0:
		Mat rgbThresholdInput = blurOutput;
		double[] rgbThresholdRed = {0.0, 117.12121790105645};
		double[] rgbThresholdGreen = {78.43692141064142, 255.0};
		double[] rgbThresholdBlue = {0.0, 127.72726405750622};
		...
		double[] filterContoursSolidity = {87.73248169286923, 100};
